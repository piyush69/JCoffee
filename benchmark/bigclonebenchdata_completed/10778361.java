...
public MyHelperClass f;
	public MyHelperClass getWriter(String o0){ return null; }

    public void writeData(String name, int items, int mznum, int mzscale, long tstart, long tdelta, int[] peaks) {
        PrintWriter file =(PrintWriter)(Object) getWriter(name + ".txt");
        ...
        try {
            ...
            while ((boolean)(Object)test.hasNext()) {
...
public MyHelperClass println(long o0){ return null; }
	public MyHelperClass close(){ return null; }
	public MyHelperClass println(String o0){ return null; }
	public MyHelperClass println(double o0){ return null; }
	public MyHelperClass println(int o0){ return null; }}
