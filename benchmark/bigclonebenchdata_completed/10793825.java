...
public MyHelperClass HomeFactory;
    ...
    public String getRec(String attribute, String url)  throws Throwable {
        ...
        MyHelperClass Namespace = new MyHelperClass();
        Namespace oains =(Namespace)(Object) Namespace.getNamespace("http://www.openarchives.org/OAI/2.0/");
        Element root = new Element("OAI-PMH", oains);
//        MyHelperClass Namespace = new MyHelperClass();
        Namespace xsi =(Namespace)(Object) Namespace.getNamespace("xsi", "http://www.w3.org/2001/XMLSchema-instance");
        ...
        responseDate.setText((String)(Object)dt.getDate());
        ...
        if (mdfCount == 1 && idenCount == 1 && (mdPrefixValue.equals("marc21") || mdPrefixValue.equals("oai_dc") || mdPrefixValue.equals("mods"))) {
            try {
                v1 =(Vector)(Object) ((ListGetRecordsHome)(ListGetRecordsHome)(Object) HomeFactory.getInstance().getRemoteHome("ListGetRecords")).create().getRecord(idenValue, mdPrefixValue);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
            if (v1.size() == 0) {
                ...
                Element errorXML =(Element)(Object) e1.describeError(3, attribute, url, "GetRecord");
...
//                    MyHelperClass Namespace = new MyHelperClass();
                    Namespace xsimarc =(Namespace)(Object) Namespace.getNamespace("xsi", "http://www.w3.org/2001/XMLSchema-instance");
                    ...
                    Element lead = new Element("leader", "marc", "http://www.loc.gov/MARC21/slim");
                    ...
                    for (int u = 0; u < vC.size(); u = u + 2) {
                        Element ct = new Element("controlfield", "marc", "http://www.loc.gov/MARC21/slim");
                    ...
                    for (int k = 0; k < v901.size(); k++) {
                        Element datafield = new Element("datafield", "marc", "http://www.loc.gov/MARC21/slim");
                    ...
                    if (mdPrefixValue.equals("oai_dc")) {
                        try {
                            Transformer transformer = TransformerFactory.newInstance().newTransformer(new StreamSource(NewGenLibRoot.getRoot() + java.io.File.separator + "StyleSheets" +(InputStream)(Object)(InputStream)(Object)(InputStream)(Object)(InputStream)(Object)(InputStream)(Object)(InputStream)(Object) java.io.File.separator + "MARC21slim2OAIDC.xsl"));
                            Document docmarc = new Document(marcroot);
                            JDOMSource in = new JDOMSource(docmarc);
                            JDOMResult out = new JDOMResult();
                            transformer.transform(in, out);
                            Document doc2 =(Document)(Object) out.getDocument();
                            XMLOutputter out1 = new XMLOutputter();
                            out1.setTextTrim(true);
                            out1.setIndent("  ");
                            out1.setNewlines(true);
                            String s1 =(String)(Object) out1.outputString(doc2);
                            System.out.println("dublin core is" + s1);
                            Element dcroot1 =(Element)(Object) doc2.getRootElement();
                            Namespace xsi1 =(Namespace)(Object) Namespace.getNamespace("xsi", "http://www.w3.org/2001/XMLSchema-instance");
                            Namespace oainsdc =(Namespace)(Object) Namespace.getNamespace("http://www.openarchives.org/OAI/2.0/oai_dc/");
                            Element dcroot = new Element("dc", "oai_dc", "http://www.openarchives.org/OAI/2.0/oai_dc/");
                            Namespace dcns =(Namespace)(Object) Namespace.getNamespace("dc", "http://purl.org/dc/elements/1.1/");
                            ...
                            java.util.List dcList =(List)(Object) doc2.getRootElement().getChildren();
                            for (int g = 0; g < dcList.size(); g++) {
                                Element dcElem1 = (Element) dcList.get(g);
                                Element dcElem = new Element((String)(Object)dcElem1.getName(), "dc", "http://purl.org/dc/elements/1.1/");
                                dcElem.setText((String)(Object)dcElem1.getText());
                        ...
                        try {
                            ...
                            transformer =(Transformer)(Object) TransformerFactory.newInstance().newTransformer(new StreamSource(urlconn.getInputStream()));
                            Document docmarc = new Document(marcroot);
                            JDOMSource in = new JDOMSource(docmarc);
                            JDOMResult out = new JDOMResult();
                            transformer.transform(in, out);
                            ...
                            out1.setNewlines(true);
                            String s1 =(String)(Object) out1.outputString(doc2);
                            Namespace xsi1 =(Namespace)(Object) Namespace.getNamespace("xlink", "http://www.w3.org/1999/xlink");
                            Namespace oainsdc =(Namespace)(Object) Namespace.getNamespace("http://www.openarchives.org/OAI/2.0/oai_dc/");
                            Element mroot = new Element("mods",(Namespace)(Object) "http://www.loc.gov/mods/v3");
                            Namespace dcns =(Namespace)(Object) Namespace.getNamespace("http://www.loc.gov/mods/v3");
                            ...
                            java.util.List dcList =(List)(Object) doc2.getRootElement().getChildren();
                            for (int g = 0; g < dcList.size(); g++) {
                                Element mElem1 = (Element) dcList.get(g);
                                Element mElem = new Element((String)(Object)mElem1.getName(),(Namespace)(Object) "http://www.loc.gov/mods/v3");
                                if ((boolean)(Object)mElem1.hasChildren()) {
                                    java.util.List mList1 =(List)(Object) mElem1.getChildren();
                                    for (int f = 0; f < mList1.size(); f++) {
                                        Element mElem2 = (Element) mList1.get(f);
                                        Element mElem3 = new Element((String)(Object)mElem2.getName(),(Namespace)(Object) "http://www.loc.gov/mods/v3");
                                        if ((boolean)(Object)mElem2.hasChildren()) {
                                            java.util.List mList2 =(List)(Object) mElem2.getChildren();
                                            for (int h = 0; h < mList2.size(); h++) {
                                                Element mElem4 = (Element) mList1.get(h);
                                                Element mElem5 = new Element((String)(Object)mElem4.getName(),(Namespace)(Object) "http://www.loc.gov/mods/v3");
                                                mElem5.setText((String)(Object)mElem4.getText());
                                                mElem3.addContent(mElem5);
                                            }
                                        }
                                        if ((boolean)(Object)mElem2.hasChildren() == false) {
                                            mElem3.setText((String)(Object)mElem2.getText());
                                        }
                                        mElem.addContent(mElem3);
                                    }
                                }
                                if ((boolean)(Object)mElem1.hasChildren() == false) {
                                    mElem.setText((String)(Object)mElem1.getText());
                                }
            ...
            if (idenCount < 1 && mdfCount < 1) {
                Errors e1 = new Errors();
                Element errorXML =(Element)(Object) e1.describeError(2, "missing arguments: identifier,metadataprefix", url, "GetRecord");
                root.addContent(errorXML);
            } else if (idenCount < 1) {
                Errors e1 = new Errors();
                Element errorXML =(Element)(Object) e1.describeError(2, "missing argument: identifier", url, "GetRecord");
                root.addContent(errorXML);
            } else if (mdfCount < 1) {
                Errors e1 = new Errors();
                Element errorXML =(Element)(Object) e1.describeError(2, "missing argument: metadataprefix", url, "GetRecord");
                root.addContent(errorXML);
            } else if (argCount > 2) {
                Errors e1 = new Errors();
                Element errorXML =(Element)(Object) e1.describeError(2, "more number of arguments", url, "GetRecord");
                root.addContent(errorXML);
            } else {
                System.out.println("no format");
                Errors e1 = new Errors();
                Element errorXML =(Element)(Object) e1.describeError(6, "", url, "GetRecord");
                root.addContent(errorXML);
            }
        }
        ...
        s =(String)(Object) out.outputString(doc);
        return s;
    }
...
public MyHelperClass getChildren(){ return null; }
	...
	public MyHelperClass getRecord(String o0, String o1){ return null; }
	public MyHelperClass getInstance(){ return null; }
	public MyHelperClass getNamespace(String o0){ return null; }
	public MyHelperClass getNamespace(String o0, String o1){ return null; }
...
Element(String o0, String o1, String o2){}
	Element(){}
	Element(String o0, Namespace o1){}
	public MyHelperClass getChildren(){ return null; }
	public MyHelperClass addNamespaceDeclaration(Namespace o0){ return null; }
	public MyHelperClass hasChildren(){ return null; }
	public MyHelperClass setAttribute(Attribute o0){ return null; }
...
Attribute(String o0, String o1, Namespace o2){}
	Attribute(){}}
...
public MyHelperClass describeError(int o0, String o1, String o2, String o3){ return null; }}

class Transformer {

public MyHelperClass transform(JDOMSource o0, JDOMResult o1){ return null; }}
...
class ListGetRecordsHome {

public MyHelperClass create(){ return null; }}

class XMLOutputter {

public MyHelperClass setTextTrim(boolean o0){ return null; }
	public MyHelperClass outputString(Document o0){ return null; }
	public MyHelperClass setIndent(String o0){ return null; }
	public MyHelperClass setNewlines(boolean o0){ return null; }}
