...
//            MyHelperClass EnvWeb = new MyHelperClass();
            ...
            MyHelperClass ACTIVITIES_PATH = new MyHelperClass();
            pstmt.setString(2, ACTIVITIES_PATH);
            MyHelperClass FAVOURITES_PATH = new MyHelperClass();
            pstmt.setString(3, FAVOURITES_PATH);
            MyHelperClass VIEWS_PATH = new MyHelperClass();
...
ToolBarButton(String o0){}
	ToolBarButton(){}
	public MyHelperClass addEventListener(MyHelperClass o0, c11275834 o1){ return null; }
