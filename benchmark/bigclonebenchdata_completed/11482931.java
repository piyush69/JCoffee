...
public MyHelperClass ZipUtils;
    ...
    public void generate(FileObject outputDirectory, FileObject generatedOutputDirectory, List libraryModels, String tapdocXml) throws FileSystemException {
        ...
        for (Library library :(Library[])(Object) (Object[])(Object)libraryModels) {
            ...
            outputDirectory.resolveFile((String)(Object)fileNameGenerator.getLibraryDirectory(libraryLocation)).createFolder();
            try {
                {
...
//                    MyHelperClass fileNameGenerator = new MyHelperClass();
                    FileObject index =(FileObject)(Object) outputDirectory.resolveFile((String)(Object)fileNameGenerator.getLibraryDirectory(libraryLocation)).resolveFile("index.html");
                ...
                {
                    MyHelperClass XsltUtils = new MyHelperClass();
                    String result =(String)(Object) XsltUtils.xsltTransform(tapdocXml,(InputStream)(Object) getClass().getResourceAsStream("ComponentIndex.xsl"), "libraryName", libraryName);
//                    MyHelperClass fileNameGenerator = new MyHelperClass();
                    FileObject index =(FileObject)(Object) outputDirectory.resolveFile((String)(Object)fileNameGenerator.getLibraryDirectory(libraryLocation)).resolveFile("components.html");
                    Writer out =(Writer)(Object) new OutputStreamWriter(index.getContent().getOutputStream(), "UTF-8");
                    out.write(result);
                    out.close();
                }
            ...
            for (Component component :(Component[])(Object) (Object[])(Object)library.getComponents()) {
                ...
                try {
//                    MyHelperClass fileNameGenerator = new MyHelperClass();
                    FileObject index =(FileObject)(Object) outputDirectory.resolveFile((String)(Object)fileNameGenerator.getComponentIndexFile(libraryLocation, componentName, true));
...
//                                            MyHelperClass IOUtils = new MyHelperClass();
        ...
        }
        {
            ...
            try {
                {
                    MyHelperClass XsltUtils = new MyHelperClass();
                    String result =(String)(Object) XsltUtils.xsltTransform(tapdocXml,(InputStream)(Object) getClass().getResourceAsStream("LibraryIndex.xsl"));
                    FileObject index =(FileObject)(Object) outputDirectory.resolveFile("libraries.html");
                    out =(Writer)(Object) new OutputStreamWriter(index.getContent().getOutputStream(), "UTF-8");
                    out.write(result);
                    out.close();
                }
                {
                    ...
                    FileObject index =(FileObject)(Object) outputDirectory.resolveFile("overview.html");
                    out =(Writer)(Object) new OutputStreamWriter(index.getContent().getOutputStream(), "UTF-8");
                    out.write(result);
                    out.close();
                }
                {
                    MyHelperClass XsltUtils = new MyHelperClass();
                    String result =(String)(Object) XsltUtils.xsltTransform(tapdocXml,(InputStream)(Object) getClass().getResourceAsStream("AllComponents.xsl"));
                    FileObject index =(FileObject)(Object) outputDirectory.resolveFile("allcomponents.html");
                    out =(Writer)(Object) new OutputStreamWriter(index.getContent().getOutputStream(), "UTF-8");
                    out.write(result);
                    out.close();
                }
