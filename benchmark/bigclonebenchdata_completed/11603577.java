...
class c11603577 {
public MyHelperClass MinLevel;
	public MyHelperClass Chunker;
	public MyHelperClass cdDoc;
	public MyHelperClass sgOverallGraph;
	public MyHelperClass DocumentSet;
	public MyHelperClass appendToLog(String o0){ return null; }

    private void analyseCorpus(final IStatusDisplayer fStatus)  throws Throwable {
        final String sDistrosFile = "Distros.tmp";
        final String sSymbolsFile = "Symbols.tmp";
        MyHelperClass Chunker = new MyHelperClass();
        Chunker = new EntropyChunker();
        int Levels = 2;
        MyHelperClass sgOverallGraph = new MyHelperClass();
        sgOverallGraph = new SymbolicGraph(1, Levels);
        MyHelperClass siIndex = new MyHelperClass();
        ...
        try {
            MyHelperClass FilePathEdt = new MyHelperClass();
            ...
            while (iIter.hasNext()) {
                ...
                for (int iCnt = 0; iCnt < cdDoc.length; iCnt++) {
                    ...
                    while (!t.addThreadFor(new Runnable() {
                        ...
                        public void run() {
                            MyHelperClass RightToLeftText = new MyHelperClass();
