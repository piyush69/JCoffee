...
class c11683526 {
public static MyHelperClass updateLastActivity(MyHelperClass o0){ return null; }
public static MyHelperClass currentLastActivity;
	public static MyHelperClass getTimeStamp(){ return null; }
//	public MyHelperClass updateLastActivity(MyHelperClass o0){ return null; }
//public MyHelperClass currentLastActivity;
//	public MyHelperClass getTimeStamp(){ return null; }
    ...
    private static boolean moveFiles(String sourceDir, String targetDir) {
        ...
        for (int x = 0; x < fileList.length; x++) {
            ...
            if (success) {
                ...
                if (!success) {
                    ...
                    try {
                        in =(FileChannel)(Object) (new FileInputStream(f).getChannel());
        ...
        if (fileMoved && !isFinished) {
            try {
                currentLastActivity =(MyHelperClass)(Object) System.currentTimeMillis();
