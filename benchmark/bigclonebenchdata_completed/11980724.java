...
class c11980724 {
    ...
    protected IRunnableWithProgress getProjectCreationRunnable()  throws Throwable {
        return new IRunnableWithProgress() {
            ...
            public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
                ...
                MyHelperClass fMainPage = new MyHelperClass();
...
//                MyHelperClass newProject = new MyHelperClass();
                ...
                MyHelperClass ModuloLauncherPlugin = new MyHelperClass();
...
//                    MyHelperClass newProject = new MyHelperClass();
                    ...
                    MyHelperClass ModuloClasspathContainer = new MyHelperClass();
