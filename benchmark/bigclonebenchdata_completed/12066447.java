...
public MyHelperClass LogLog;
    ...
    protected void truncate(final File file)  throws Throwable {
        ...
        if ((boolean)(Object)FileUtils.isFileOlder(file, ManagementFactory.getRuntimeMXBean().getStartTime())) {
            final File backupRoot = new File((String)(Object)this.getBackupDir());
            ...
            try {
                ...
                throw(Throwable)(Object) new AppenderInitializationError("Invalid date formate for backup files: " + this.getBackupDateFormat(), e);
            }
            final String date =(String)(Object) df.format(new Date(file.lastModified()));
