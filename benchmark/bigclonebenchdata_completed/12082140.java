...
class c12082140 {
public static MyHelperClass getDescripcionTipoVia(MyHelperClass o0){ return null; }
//public MyHelperClass getDescripcionTipoVia(MyHelperClass o0){ return null; }

    public static Set getVias(String pURL) {
            ...
            while ((str =(String)(Object) br.readLine()) != null) {
                ...
                if (error) {
                    ...
                    if (str.contains(iniVia)) {
                        via = new Street();
                        while ((str =(String)(Object) br.readLine()) != null && !str.contains(finVia)) {
...
public MyHelperClass add(Street o0){ return null; }}

class Street {

public MyHelperClass setStreetName(String o0){ return null; }
	public MyHelperClass setTypeStreet(TypeStreet o0){ return null; }
	public MyHelperClass setCodeStreet(int o0){ return null; }}
...
public MyHelperClass setDescription(MyHelperClass o0){ return null; }
	public MyHelperClass getCodetpStreet(){ return null; }
	public MyHelperClass setCodetpStreet(String o0){ return null; }}
