...
class c12255573 {
                        ...
                        public Constructor run() throws Exception {
                            ...
                            if (loader == null) {
                                urls =(Enumeration)(Object) BeanletApplicationContext.class.getClassLoader().getResources(path);
                            } else {
                                ...
                                try {
                                    ...
                                    while ((className =(String)(Object) reader.readLine()) != null) {
                                        ...
                                        if (!name.startsWith("#") && !name.startsWith(";") && !name.startsWith("//")) {
                                            ...
                                            if (BeanletApplicationContext.class.isAssignableFrom(cls) && !(Boolean)(Object)Modifier.isAbstract(m) && !(Boolean)(Object)Modifier.isInterface(m)) {
...
class BeanletApplicationException extends Exception{
	public BeanletApplicationException(String errorMessage) { super(errorMessage); }
}
