...
public MyHelperClass RewriteUtils;
	...
	public MyHelperClass httpClientResponse;
    ...
    private void removeSessionId(InputStream inputStream, Output output) throws Throwable, IOException {
        ...
        boolean textContentType =(boolean)(Object)(Object)(Object)(Object)(Object)(Object)(Object)(Object)(Object) ResourceUtils.isTextContentType(httpClientResponse.getHeader(HttpHeaders.CONTENT_TYPE), target.getDriver().getConfiguration().getParsableContentTypes());
...
public MyHelperClass copy(InputStream o0, MyHelperClass o1){ return null; }
	public MyHelperClass isTextContentType(MyHelperClass o0, MyHelperClass o1){ return null; }
	...
	public MyHelperClass getParsableContentTypes(){ return null; }
