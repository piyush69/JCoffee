...
//	public MyHelperClass decode(MyHelperClass o0){ return null; }
	...
	public static MyHelperClass encodeBytes(byte[] o0, int o1, int o2){ return null; }
//public MyHelperClass encodeBytes(byte[] o0){ return null; }
//	public MyHelperClass encodeBytes(byte[] o0, int o1, int o2){ return null; }
        ...
        try {
            {
                ...
                byte[] dbytes =(byte[])(Object) decode(encodeBytes(bytes1));
            ...
            }
            {
                ...
                InputStream b64is = new InputStream((FileInputStream)(Object)fis, DECODE);
                byte[] bytes = new byte[0];
                int b = -1;
                while ((b =(int)(Object) b64is.read()) >= 0) {
                ...
                b64is = new InputStream((FileInputStream)(Object)fis, ENCODE);
                ...
                b64is = new InputStream((FileInputStream)(Object)fis, DECODE);
            ...
            }
            {
                ...
                OutputStream b64os = new OutputStream((FileOutputStream)(Object)fos, ENCODE);
                b64os.write(rbytes);
                b64os.close();
                ...
                b64os = new OutputStream((FileOutputStream)(Object)fos, DECODE);
                b64os.write(rebytes);
                b64os.close();
            ...
            }
            {
                ...
                int b;
                while ((b =(int)(Object) b64is.read()) >= 0) fos.write(b);
                fos.close();
                b64is.close();
            }
        } catch (Exception e) {
...
InputStream(){}
	InputStream(FileInputStream o0, MyHelperClass o1){}
	public MyHelperClass read(){ return null; }
	public MyHelperClass close(){ return null; }}

class OutputStream {

OutputStream(FileOutputStream o0, MyHelperClass o1){}
	OutputStream(){}
	public MyHelperClass close(){ return null; }
