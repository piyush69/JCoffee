...
class c13456795 {
public MyHelperClass CODPRODCP;
	public MyHelperClass CODEMPRM;
	public MyHelperClass CODEMPOPSP;
	public MyHelperClass CODEMPCP;
	public MyHelperClass CODPRODVD;
	public MyHelperClass CODPRODOPSP;
	public MyHelperClass CODEMPVD;
	public MyHelperClass CODPRODRM;
	public MyHelperClass CODPRODOP;
	public MyHelperClass CODPRODIV;
	public MyHelperClass CODEMPOP;
	public MyHelperClass CODEMPIV;
	public MyHelperClass insereMov(ResultSet o0, String o1){ return null; }
public MyHelperClass Aplicativo;
	public MyHelperClass btProcessar;
	public MyHelperClass con;
	public MyHelperClass txtDataini;
    ...
    private boolean processar(int iCodProd) {
        ...
        try {
            try {
                sWhere = "";
                sProd = "";
                MyHelperClass cbTudo = new MyHelperClass();
                if (cbTudo.getVlrString().equals("S")) sProd = "[" + iCodProd + "] ";
                MyHelperClass txtDataini = new MyHelperClass();
...
//                    MyHelperClass txtDataini = new MyHelperClass();
                ...
                ps =(PreparedStatement)(Object) con.prepareStatement(sSQL);
                ps.setInt(1,(int)(Object) Aplicativo.iCodEmp);
            ...
            if (bOK) {
                ...
                try {
                    ...
                    ps =(PreparedStatement)(Object) con.prepareStatement(sSQL);
                    ps.setInt((int)(Object)CODEMPIV.ordinal(),(int)(Object) Aplicativo.iCodEmp);
                    ps.setInt((int)(Object)CODPRODIV.ordinal(), iCodProd);
                    ps.setInt((int)(Object)CODEMPCP.ordinal(),(int)(Object) Aplicativo.iCodEmp);
                    ps.setInt((int)(Object)CODPRODCP.ordinal(), iCodProd);
                    ps.setInt((int)(Object)CODEMPOP.ordinal(),(int)(Object) Aplicativo.iCodEmp);
                    ps.setInt((int)(Object)CODPRODOP.ordinal(), iCodProd);
                    ps.setInt((int)(Object)CODEMPOPSP.ordinal(),(int)(Object) Aplicativo.iCodEmp);
                    ps.setInt((int)(Object)CODPRODOPSP.ordinal(), iCodProd);
                    ps.setInt((int)(Object)CODEMPRM.ordinal(),(int)(Object) Aplicativo.iCodEmp);
                    ps.setInt((int)(Object)CODPRODRM.ordinal(), iCodProd);
                    ps.setInt((int)(Object)CODEMPVD.ordinal(),(int)(Object) Aplicativo.iCodEmp);
                    ps.setInt((int)(Object)CODPRODVD.ordinal(), iCodProd);
                    rs =(ResultSet)(Object) ps.executeQuery();
                    bOK = true;
                    while ((boolean)(Object)rs.next() && bOK) {
                        bOK =(boolean)(Object) insereMov(rs, sProd);
                    }
                    rs.close();
                    ps.close();
...
public MyHelperClass ordinal(){ return null; }
	...
	public MyHelperClass getVlrDate(){ return null; }
	public MyHelperClass mensagemErro(Object o0, String o1, boolean o2, MyHelperClass o3, SQLException o4){ return null; }
	public MyHelperClass dateToStrDB(MyHelperClass o0){ return null; }
