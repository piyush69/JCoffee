...
//    @Override
    protected ResourceHandler doGet(final URI resourceUri) throws Throwable, ResourceException {
        if (resourceUri.getHost() == null) {
            throw new IllegalStateException((String)(Object)StoreMessageBundle.getMessage("store.uri.ftp.illegal", resourceUri.toString()));
        }
        try {
