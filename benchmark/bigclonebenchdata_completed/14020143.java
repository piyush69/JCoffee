...
public MyHelperClass encoding;
	public MyHelperClass privacy;
	public MyHelperClass log;
	public MyHelperClass QOP_AUTH;
	public MyHelperClass finalizeAuthentication;
	public MyHelperClass QOP_AUTH_CONF;
	public MyHelperClass QOP_AUTH_INT;
	public MyHelperClass nonces;
	public MyHelperClass configurationManager;
	public MyHelperClass locale;
	public MyHelperClass MD5DigestSessionKey;
	public MyHelperClass integrity;
	public MyHelperClass sessionCipher;
	public MyHelperClass toHex(byte[] o0, int o1){ return null; }
	public MyHelperClass decodeAllAs8859(Map o0){ return null; }
	public MyHelperClass responseTokenProcessor(List<byte[] o0, Map o1, String o2, int o3, int o4){ return null; }
	public MyHelperClass MD5Digest(String o0){ return null; }
	public MyHelperClass splitByteArray(byte[] o0, byte o1){ return null; }
	public MyHelperClass decodeMixed(Map o0){ return null; }

    public byte[] evaluateResponse(byte[] responseBytes) throws Throwable, SaslException {
        MyHelperClass firstEvaluation = new MyHelperClass();
        if (firstEvaluation) {
            MyHelperClass firstEvaluation = new MyHelperClass();
...
public MyHelperClass decodeBase64(byte[] o0){ return null; }
	public MyHelperClass isArrayByteBase64(byte[] o0){ return null; }
	public MyHelperClass encodeBase64(byte[] o0){ return null; }}

class MalformedBase64ContentException extends Exception{
	public MalformedBase64ContentException(String errorMessage) { super(errorMessage); }
}
