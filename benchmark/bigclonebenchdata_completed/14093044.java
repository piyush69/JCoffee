...
public MyHelperClass Logger;
	public MyHelperClass filasInsert;
...
//    @Override
    public boolean insert(String consulta, boolean autocommit, int transactionIsolation, Connection cx) throws Throwable, SQLException {
        int filasInsert =(int)(Object) NULL; //new int();
        filasInsert = 0;
        if (!consulta.contains(";")) {
            ...
            if ((boolean)(Object)this.tipoConsulta.hasNext()) {
                ...
                if ((boolean)(Object)execConsulta.equalsIgnoreCase("insert")) {
                    ...
                    try {
                        ...
                        filasInsert =(int)(Object) st.executeUpdate(consulta.trim(), Statement.RETURN_GENERATED_KEYS);
                        if ((int)(Object)filasInsert > -1) {
                            if (autocommit == false) {
                                conexion.commit();
                            }
                            return true;
