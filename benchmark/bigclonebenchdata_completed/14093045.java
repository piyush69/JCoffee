...
public MyHelperClass Logger;
	...
	public MyHelperClass filasDelete;

//    @Override
    public boolean delete(String consulta, boolean autocommit, int transactionIsolation, Connection cx) throws Throwable, SQLException {
        int filasDelete =(int)(Object) NULL; //new int();
        filasDelete = 0;
        if (!consulta.contains(";")) {
            ...
            if ((boolean)(Object)this.tipoConsulta.hasNext()) {
                ...
                if ((boolean)(Object)execConsulta.equalsIgnoreCase("delete")) {
                    ...
                    try {
                        ...
                        filasDelete =(int)(Object) st.executeUpdate(consulta.trim(), Statement.RETURN_GENERATED_KEYS);
                        if ((int)(Object)filasDelete > -1) {
                            if (autocommit == false) {
                                conexion.commit();
                            }
                            return true;
