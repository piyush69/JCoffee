...
public MyHelperClass log;
    ...
    private void initSerializerFiles(String fileName, HashSet<String> fileList, HashMap<Class, Class> classMap, Class type)  throws Throwable {
        try {
            ClassLoader classLoader =(ClassLoader)(Object) getClassLoader();
            ...
            throw new HessianException((String)(Object)e);
        }
    }
...
class HessianException extends Exception{
	public HessianException(String errorMessage) { super(errorMessage); }
}
