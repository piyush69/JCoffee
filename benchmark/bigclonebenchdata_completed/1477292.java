...
public MyHelperClass IOUtils;
    ...
    public void testCreate() throws Exception {
        ...
        try {
            ...
            assertEquals("GB2312",(String)(Object) i.getEncoding());
            assertEquals((String)(Object)200005L,(String)(Object) i.getLastModified());
            ...
            i.updateAfterAllContentUpdated(null, null);
            {
                ...
                for (ResponseHeader h :(ResponseHeader[])(Object) (Object[])(Object)i.getHeaders()) {
                    ...
                    if (ii == 1) {
                        ...
                        assertEquals("[279]", Arrays.toString((long[])(Object)h.getValues()));
                    } else if (ii == 2) {
...
public MyHelperClass size(){ return null; }
	public MyHelperClass copy(FileInputStream o0, StringWriter o1, String o2){ return null; }
