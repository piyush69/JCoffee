...
public MyHelperClass JFileChooser;
	public MyHelperClass trackMap;
	public MyHelperClass templateDesc;
	public MyHelperClass insertBefore;
	public MyHelperClass Jampal;
	public MyHelperClass mainFrame;
	public MyHelperClass trackVec;
	public MyHelperClass JOptionPane;
	public MyHelperClass templateNames;
	public MyHelperClass attributes;

     void Library(MainFrame mf, boolean newLibrary, String templateName, String newFileName) throws Exception {
        mainFrame = mf;
        ...
        if (newLibrary) {
            ...
            if (ix == -1) {
                ...
                copyLibrary = true;
                creatingPlaylist = (attributes.libraryType == 'P');
            } else {
