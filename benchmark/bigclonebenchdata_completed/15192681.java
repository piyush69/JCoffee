...
public MyHelperClass data;
	...
	public MyHelperClass descriptorTable;

    public  void DataSetInfo(String request) throws Throwable, AddeURLException {
        URLConnection urlc;
...
class AddeURLException extends Exception{
	public AddeURLException(String errorMessage) { super(errorMessage); }
}
