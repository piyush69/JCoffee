...
public MyHelperClass getArrayType(Class o0){ return null; }
    ...
    public boolean checkTypeChange(Class<?> clazz, File buildDir, File refFile) throws Throwable, MojoExecutionException {
        if (!clazz.isPrimitive()) {
            ClassLoader cl = clazz.getClassLoader();
            MyHelperClass loader = new MyHelperClass();
            if (cl == (ClassLoader)(Object)loader) {
                if (clazz.isArray()) return checkTypeChange((Class<?>)(Object)getArrayType(clazz), buildDir, refFile);
