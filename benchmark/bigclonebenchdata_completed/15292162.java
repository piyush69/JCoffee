...
//	public MyHelperClass verify(Report o0, EODQuote o1){ return null; }
    ...
    private static List retrieveQuotes(Report report, Symbol symbol, String prefix, TradingDate startDate, TradingDate endDate) throws Throwable, ImportExportException {
        List quotes = new ArrayList();
        String URLString =(String)(Object) constructURL(symbol, prefix, startDate, endDate);
        EODQuoteFilter filter =(EODQuoteFilter)(Object) new GoogleEODQuoteFilter(symbol);
...
class GoogleEODQuoteFilter {

GoogleEODQuoteFilter(Symbol o0){}
	GoogleEODQuoteFilter(){}}
