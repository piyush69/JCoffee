...
class c15507613 {
public MyHelperClass WINDOW_CENTER_PARAM;
	public MyHelperClass log;
	public MyHelperClass WINDOW_WIDTH_PARAM;
	public MyHelperClass getElementValue(String o0){ return null; }
...
//    @Override
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws Throwable, ServletException, IOException {
        ...
        try {
            ...
            MyHelperClass dicomData = new MyHelperClass();
