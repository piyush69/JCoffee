...
public MyHelperClass activatorClass;
    ...
    public void ForkJavaProject(String projectName, Class<?> activatorClass) {
        ...
        try {
            ...
            Activator.getDefault().getLog().log(new Status(Status.ERROR, Activator.PLUGIN_ID, "An exception has been thrown while creating Project",(CoreException)(Object) e));
        }
    }
...
Status(MyHelperClass o0, MyHelperClass o1, String o2, CoreException o3){}
	Status(){}}
