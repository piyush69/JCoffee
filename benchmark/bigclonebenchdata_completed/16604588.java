...
class c16604588 {
public static MyHelperClass getAudioFileFormatForUrl(InputStream o0){ return null; }
//public MyHelperClass getAudioFileFormatForUrl(InputStream o0){ return null; }
...
//            MyHelperClass useragent = new MyHelperClass();
        ...
        try {
            ...
            return(AudioFileFormat)(Object) getAudioFileFormatForUrl(inputStream);
        } finally {
            inputStream.close();
        }
    }
