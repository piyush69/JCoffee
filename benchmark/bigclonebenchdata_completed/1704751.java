...
class c1704751 {
    ...
    public static void copy(File fromFile, File toFile) throws IOException {
        String fromFilename =(String)(Object) fromFile.getPath();
        String toFileName =(String)(Object) toFile.getPath();
        ...
        if ((boolean)(Object)toFile.exists()) {
            ...
            MyHelperClass AppState = new MyHelperClass();
            if ((boolean)(Object)AppState.isVerbose()) System.out.print("Overwrite existing file " + toFile.getName() + "? (Y/N): ");
            System.out.flush();
