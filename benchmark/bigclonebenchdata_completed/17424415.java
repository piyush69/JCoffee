...
class c17424415 {
    ...
    public static HttpClientStatus putRemoteCalendar(URL url, final String username, final String password, File inputFile) {
        if (!inputFile.exists() || inputFile.length() <= 0) {
            MyHelperClass HttpClientStatus = new MyHelperClass();
...
class MyHelperClass {
public MyHelperClass HTTP_STATUS_SUCCESS;
	public MyHelperClass HTTP_STATUS_OTHER_ERROR;
	public MyHelperClass HTTP_STATUS_AUTH_REQUIRED;
	public MyHelperClass HTTP_STATUS_NOT_FOUND;
}

class HttpClientStatus {

HttpClientStatus(MyHelperClass o0, String o1, IOException o2){}
	HttpClientStatus(){}
	HttpClientStatus(MyHelperClass o0, String o1){}}
