...
class c17635420 {
public static MyHelperClass TelechargerPluginEtCharger(ControleurDeMenu o0, String o1){ return null; }
//public MyHelperClass TelechargerPluginEtCharger(ControleurDeMenu o0, String o1){ return null; }

    public static void verifierSiDerniereVersionDesPluginsMenus(ControleurDeMenu i)  throws Throwable {
        if (i.getURLFichierInfoDerniereVersion() == null ||(String)(Object) i.getURLFichierInfoDerniereVersion() == "") {
        ...
        File destination;
        try {
            MyHelperClass compteurDeFichiersTemporaires = new MyHelperClass();
...
class MyHelperClass {
public int compteurDeFichiersTemporaires;
}

class ControleurDeMenu {

public MyHelperClass getVersionPlugin(){ return null; }
	public MyHelperClass getURLFichierInfoDerniereVersion(){ return null; }
	public MyHelperClass getNomPlugin(){ return null; }}
