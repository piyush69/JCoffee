...
public MyHelperClass URLEncoder;
    ...
    public String[][] getProjectTreeData() {
        ...
        String filename =(int)(Object) dms_home + (int)(Object)FS + "temp" + FS + username + "projects.xml";
        ...
        try {
            ...
            NodeList nodelist =(NodeList)(Object) document.getElementsByTagName("j");
            int num =(int)(Object) nodelist.getLength();
            treeData = new String[num][5];
            for (int i = 0; i < num; i++) {
                MyHelperClass DOMUtil = new MyHelperClass();
                treeData[i][0] = new String((String)(Object)DOMUtil.getSimpleElementText((Element)(Element)(Object) nodelist.item(i), "i"));
//                MyHelperClass DOMUtil = new MyHelperClass();
                treeData[i][1] = new String((String)(Object)DOMUtil.getSimpleElementText((Element)(Element)(Object) nodelist.item(i), "pi"));
//                MyHelperClass DOMUtil = new MyHelperClass();
                treeData[i][2] = new String((String)(Object)DOMUtil.getSimpleElementText((Element)(Element)(Object) nodelist.item(i), "p"));
                treeData[i][3] = "";
//                MyHelperClass DOMUtil = new MyHelperClass();
                treeData[i][4] = new String((String)(Object)DOMUtil.getSimpleElementText((Element)(Element)(Object) nodelist.item(i), "f"));
            }
