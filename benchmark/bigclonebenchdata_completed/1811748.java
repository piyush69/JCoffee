...
public MyHelperClass server;
    ...
    public void testSimpleHttpPostsHTTP10() throws Throwable, Exception {
        int reqNo = 20;
        ...
        try {
            for (int r = 0; r < reqNo; r++) {
                ...
                assertEquals((byte)(Object)HttpVersion.HTTP_1_0,(byte)(Object) response.getStatusLine().getProtocolVersion());
