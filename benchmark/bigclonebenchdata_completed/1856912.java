...
public static MyHelperClass MapMode;
	public static MyHelperClass predictPearsonWeightedSlopeOneRating(MyHelperClass o0, short o1, int o2, TShortObjectHashMap o3){ return null; }
public static MyHelperClass fSep;
	public static MyHelperClass knn;
	public static MyHelperClass ByteBuffer;
	public static MyHelperClass Arrays;
//	public MyHelperClass MapMode;
	public static MyHelperClass movieAverages;
//	public MyHelperClass predictPearsonWeightedSlopeOneRating(MyHelperClass o0, short o1, int o2, TShortObjectHashMap o3){ return null; }
	public static MyHelperClass loadMovieDiffStats(String o0, short o1, String o2){ return null; }
//public MyHelperClass ByteBuffer;
//	public MyHelperClass knn;
//	public MyHelperClass fSep;
//	public MyHelperClass movieAverages;
...
//                MyHelperClass fSep = new MyHelperClass();
                ...
                for (int i = 0; i < movies.length; i++) {
                    ...
                    movieDiffStats =(TShortObjectHashMap)(Object) loadMovieDiffStats(completePath, movieToProcess, CFDataFolderName);
                    ...
                    for (int j = 0; j < (int)(Object)customersToProcess.size(); j++) {
                        ...
                        finalPrediction =(double)(Object) predictPearsonWeightedSlopeOneRating(knn, movieToProcess, customerToProcess, movieDiffStats);
                        ...
                        } else finalPrediction =(double)(Object) movieAverages.get(movieToProcess);
                ...
                for (int i = 0; i < movies.length; i++) {
                    ...
                    for (int j = 0; j < (int)(Object)customersToProcess.size(); j++) {
                        ...
                        if (finalPrediction == finalPrediction) {
                            ...
                            finalPrediction =(double)(Object) movieAverages.get(movieToProcess);
