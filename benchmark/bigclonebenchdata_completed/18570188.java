...
public MyHelperClass Logger;
    ...
    public ViewedCandidatesIndex getAllViewedCandidates() throws Throwable, BookKeeprCommunicationException {
        try {
...
//                MyHelperClass httpClient = new MyHelperClass();
                ...
                if (resp.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                    try {
                        ...
                        in.close();
                        if ((ViewedCandidatesIndex)(Object)xmlable instanceof ViewedCandidatesIndex) {
                            ViewedCandidatesIndex p = (ViewedCandidatesIndex)(ViewedCandidatesIndex)(Object) xmlable;
                            return p;
                        } else {
