...
public MyHelperClass Logger;
    ...
    public ViewedCandidates postViewedCandidates(ViewedCandidates viewedCandidates) throws Throwable, BookKeeprCommunicationException {
        try {
...
//                MyHelperClass httpClient = new MyHelperClass();
                ...
                if (resp.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                    try {
                        ...
                        in.close();
                        if ((ViewedCandidates)(Object)xmlable instanceof ViewedCandidates) {
                            ViewedCandidates p = (ViewedCandidates)(ViewedCandidates)(Object) xmlable;
                            return p;
                        } else {
