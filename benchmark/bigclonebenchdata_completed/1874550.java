...
class c1874550 {
public MyHelperClass allowedHttpMethods;
	public MyHelperClass Pattern;
	public MyHelperClass responseBuffer;
    ...
    public String doAction(Action commandAction) throws Throwable, Exception {
        Map<String, String> args = commandAction.getArgs();
        EnumCommandActionType actionType = commandAction.getType();
        String actionResult = "";
        switch(actionType) {
            MyHelperClass SEND = new MyHelperClass();
            case SEND:
