...
class c18899338 {
    ...
    public static void parseSohuStock(ArrayList<String> dataSource, final ArrayList<SohuStockBean> sohuStockBeanList) throws Throwable, IOReactorException, InterruptedException {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (resp != null && resp.length() > 0) {
                                    MyHelperClass SohuStockPostProcess = new MyHelperClass();
...
class MyHelperClass {
public int count;
public MyHelperClass postSohuStockBeanProcess(String o0){ return null; }}
