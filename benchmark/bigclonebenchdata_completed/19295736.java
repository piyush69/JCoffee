...
public MyHelperClass ConfigNat;
...
//        MyHelperClass OptNames = new MyHelperClass();
        ...
        try {
            ...
            in =(FileChannel)(Object) (new FileInputStream(fichTable).getChannel());
            out =(FileChannel)(Object) (new FileOutputStream(ConfigNat.getUserTempFolder() + "Table_pour_chaines.ent").getChannel());
            in.transferTo(0, in.size(), out);
            in.close();
            out.close();
        } catch (UncheckedIOException e) {
...
public MyHelperClass getUserTempFolder(){ return null; }
