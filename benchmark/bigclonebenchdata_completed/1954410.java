...
public MyHelperClass saveErrors(HttpServletRequest o0, ActionMessages o1){ return null; }
	...
	public MyHelperClass getMailInstance(HttpServletRequest o0){ return null; }
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Throwable, Exception {
        ...
        try {
            ...
            Mail mailInstance =(Mail)(Object) getMailInstance(request);
            if (isMultipart) {
                ...
                while (iter.hasNext()) {
                    ...
                    if ((boolean)(Object)item.isFormField()) {
                        if (item.getFieldName().equals("forwardAttachments")) {
                            String[] aux =(String[])(Object) item.getString().split(":");
                            MailPartObj part =(MailPartObj)(Object) mailInstance.getAttachment(aux[0], aux[1]);
                        ...
                        if (!(Boolean)(Object)StringUtils.isBlank((String)(Object)item.getName())) {
                ...
                MyHelperClass StringUtils = new MyHelperClass();
                if ((boolean)(Object)StringUtils.isBlank(mid)) {
                ...
                Boolean isHtml = null;
//                MyHelperClass StringUtils = new MyHelperClass();
                if ((boolean)(Object)StringUtils.isBlank((String) fields.get("isHtml"))) {
                    isHtml = new Boolean((boolean)(Object)preferencesInstance.getPreferences().isHtmlMessage());
                } else {
...
public MyHelperClass getAttachment(String o0, String o1){ return null; }}
...
public MyHelperClass send(String o0, int o1, String o2, String o3, String o4, String o5, String o6, Vector o7, boolean o8, MyHelperClass o9, String o10){ return null; }}
