...
public MyHelperClass entidad2;
	...
	public MyHelperClass actualizarBZENTRA(Connection o0){ return null; }
    ...
    public boolean visar() throws Throwable, SQLException, ClassNotFoundException, Exception {
        ...
        try {
            ...
            String sentenciaSql = "UPDATE BZMODIF SET FZJCUSVI=?, FZJFVISA=?, FZJHVISA=?" + (((boolean)(Object)hayVisadoExtracto) ? ", FZJIEXTR=?" : "") + (((boolean)(Object)hayVisadoRemitente) ? ", FZJIREMI=?" : "") + " WHERE FZJCENSA='E' AND FZJCAGCO=? AND FZJNUMEN=? AND FZJANOEN=? AND FZJFMODI=? AND FZJHMODI=?";
...
//            MyHelperClass hayVisadoExtracto = new MyHelperClass();
            if (registrosAfectados > 0 && ((Boolean)(Object)hayVisadoExtracto || (Boolean)(Object)hayVisadoRemitente)) {
                ...
                if (generado) {
                    visado =(boolean)(Object) actualizarBZENTRA(conn);
                }
                String rem = "";
                String com = "";
//                MyHelperClass hayVisadoRemitente = new MyHelperClass();
...
//                    MyHelperClass anoEntrada = new MyHelperClass();
                    Object[] params = { "V", new Integer((int)(Object)anoEntrada), new Integer((int)(Object)numeroRegistro), new Integer((int)(Object)oficina), new Integer((int)(Object)fechaDocumento), rem, com, tipoDocumento, new Integer((int)(Object)fechaRegistro), new Integer((int)(Object)fzacagge), fora, new Integer((int)(Object)destinatario), idioma, null, null, null, null, null, null, null };
            ...
            logLopdBZMODIF("UPDATE", sessioEjb.getCallerPrincipal().getName().toUpperCase(), fzafsis, horamili, 'E', numeroRegistro, anoEntrada, oficina, Integer.parseInt((String)(Object)fechaModificacion), Integer.parseInt((String)(Object)horaModificacion));
        } catch (Exception e) {
