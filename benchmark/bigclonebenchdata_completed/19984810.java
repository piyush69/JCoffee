...
//public MyHelperClass logger;
    ...
    public static boolean copyDataToNewTable(EboContext p_eboctx, String srcTableName, String destTableName, String where, boolean log, int mode) throws boRuntimeException {
        ...
        try {
            ...
            PreparedStatement pstm =(PreparedStatement)(Object) cn.prepareStatement("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE upper(TABLE_NAME)=?  AND TABLE_SCHEMA=database()");
            ...
            if (!destexists) {
                rslt.close();
                pstm.close();
                pstm =(PreparedStatement)(Object) cn.prepareStatement("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.VIEWS WHERE upper(TABLE_NAME)=? AND TABLE_SCHEMA=database()");
                pstm.setString(1, destTableName);
                rslt =(ResultSet)(Object) pstm.executeQuery();
                if ((boolean)(Object)rslt.next()) {
            ...
            if (srcexists && !destexists) {
                ...
                PreparedStatement pstm2 =(PreparedStatement)(Object) cn.prepareStatement("SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE upper(TABLE_NAME) = ? AND TABLE_SCHEMA=database()");
                pstm2.setString(1, destTableName);
                ResultSet rslt2 =(ResultSet)(Object) pstm2.executeQuery();
                StringBuffer fields = new StringBuffer();
                PreparedStatement pstm3 =(PreparedStatement)(Object) cn.prepareStatement("SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE upper(TABLE_NAME) = ? and upper(COLUMN_NAME)=? AND TABLE_SCHEMA=database()");
