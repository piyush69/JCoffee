...
class c20029245 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        readfilelen =(long)(Object) brafReadFile.initfilelen;
        brafWriteFile = new BufferedRandomAccessFile(".\\STKAITI.001", "rw", 10);
        byte buf[] = new byte[1024];
        int readcount;
        long start = System.currentTimeMillis();
        while ((readcount =(int)(Object) brafReadFile.read(buf)) != -1) {
...
public MyHelperClass filename;
	public MyHelperClass initfilelen;
BufferedRandomAccessFile(String o0, String o1, int o2){}
	BufferedRandomAccessFile(String o0){}
