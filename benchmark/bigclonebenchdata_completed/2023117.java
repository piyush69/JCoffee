...
class c2023117 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < (int)(Object)cb.getEachResultStartposisions().size(); i++) {
            HashMap m =(HashMap)(Object) cb.getEachResultStartposisions().get(i);
...
class AcmSearchresultPageParser_2008Apr {

public MyHelperClass getAllDocNum(){ return null; }
	public MyHelperClass getEachResultStartposisions(){ return null; }}
...
public MyHelperClass parse(BufferedReader o0, AcmSearchresultPageParser_2008Apr o1, boolean o2){ return null; }}
