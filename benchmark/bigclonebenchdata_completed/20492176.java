...
public MyHelperClass GuidUtil;
    ...
    public String postEvent(EventDocument eventDoc, Map attachments) {
        ...
        MyHelperClass jmsTemplate = new MyHelperClass();
        if (jmsTemplate == null) {
        ...
        MyHelperClass destinationName = new MyHelperClass();
...
public MyHelperClass setEventId(MyHelperClass o0){ return null; }
	public MyHelperClass convertAndSend(InternalEventObject o0){ return null; }
	...
	public MyHelperClass convertAndSend(MyHelperClass o0, InternalEventObject o1){ return null; }
