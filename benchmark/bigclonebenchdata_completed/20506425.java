...
class c20506425 {
public MyHelperClass lHandler;
	public MyHelperClass dtdHandler;
	public MyHelperClass xiFallbackFlag;
	public MyHelperClass inXInclude;
	public MyHelperClass documentURI;
	public MyHelperClass dHandler;
	public MyHelperClass cHandler;
	public MyHelperClass localParser;

    private void handleXInclude(final String localName, final Attributes atts)  throws Throwable {
