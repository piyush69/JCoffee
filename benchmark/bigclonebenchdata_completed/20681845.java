...
public MyHelperClass CONTENT2_FILE;
    ...
    public void testCreateNewXMLFile() throws InvalidNodeTypeDefException, ParseException, Exception {
        ...
        InputStream contentIn2 =(InputStream)(Object) getClass().getResourceAsStream((String)(Object)CONTENT2_FILE);
        sourceOut =(OutputStream)(Object) emptySource.getOutputStream();
        try {
        ...
        InputStream expected =(InputStream)(Object) getClass().getResourceAsStream((String)(Object)CONTENT2_FILE);
