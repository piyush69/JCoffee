...
public MyHelperClass CLogger;
	public MyHelperClass MCategoriaIva;
    ...
    protected String doIt() throws java.lang.Exception {
        ...
        MyHelperClass m_deleteOldImported = new MyHelperClass();
...
//        MyHelperClass log = new MyHelperClass();
        ...
        try {
            ...
            while ((boolean)(Object)rs.next()) {
                int I_BPartner_ID =(int)(Object) rs.getInt(1);
                int C_BPartner_ID =(int)(Object) rs.getInt(2);
                boolean newBPartner = C_BPartner_ID == 0;
                int C_BPartner_Location_ID =(int)(Object) rs.getInt(3);
                String newLocali =(String)(Object) rs.getString(4);
                boolean newLocation = rs.getString(4) != null;
                int AD_User_ID =(int)(Object) rs.getInt(5);
                ...
                if (newBPartner) {
                    ...
                    if ((boolean)(Object)bp.save()) {
                        C_BPartner_ID =(int)(Object) bp.getC_BPartner_ID();
                    ...
                    try {
                        no =(int)(Object) pstmt_updateBPartner.executeUpdate();
                ...
                if (C_BPartner_Location_ID != 0) {
                    ...
                    int C_Location_ID = 0;
                    try {
                        C_Location_ID =(int)(Object) DB.getNextID(m_AD_Client_ID, "C_Location", null);
                        if (C_Location_ID <= 0) {
                        ...
                        no =(int)(Object) pstmt_insertLocation.executeUpdate();
                    ...
                    try {
                        C_BPartner_Location_ID = ((int)(Object)DB.getNextID(m_AD_Client_ID, "C_BPartner_Location", null));
                        ...
                        no =(int)(Object) pstmt_insertBPLocation.executeUpdate();
                ...
                if (AD_User_ID != 0) {
                    ...
                    try {
                        no =(int)(Object) pstmt_updateBPContact.executeUpdate();
                    ...
                    try {
                        AD_User_ID =(int)(Object) DB.getNextID(m_AD_Client_ID, "AD_User", null);
                        if (AD_User_ID <= 0) {
                        ...
                        no =(int)(Object) pstmt_insertBPContact.executeUpdate();
...
class MyHelperClass {
public MyHelperClass CONSUMIDOR_FINAL;
	public MyHelperClass NUMERIC;
	public MyHelperClass TRANSACTION_READ_COMMITTED;
public MyHelperClass retrieveErrorAsString(){ return null; }
...
X_I_BPartner(){}
	X_I_BPartner(MyHelperClass o0, int o1, Object o2){}}
