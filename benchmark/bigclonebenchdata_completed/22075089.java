...
class c22075089 {
    ...
    public static void executa(String arquivo, String filial, String ip) {
        ...
        Properties p =(Properties)(Object) Util.lerPropriedades(arquivo);
        ...
        if (filial.equalsIgnoreCase(servidor)) {
            ...
            try {
                ...
                out = new BufferedOutputStream((OutputStream)(Object)new GZIPOutputStream(s.getOutputStream()));
...
public MyHelperClass lerPropriedades(String o0){ return null; }}
