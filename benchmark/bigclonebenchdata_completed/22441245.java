...
public MyHelperClass messageable;
    ...
    public void saveDraft(Session hsession, Session session, String repositoryName, int ideIdint, String to, String cc, String bcc, String subject, String body, Vector attachments, boolean isHtml, String charset, InternetHeaders headers, String priority) throws Throwable, MailException {
        try {
            if (charset == null) {
...
//                        MyHelperClass IOUtils = new MyHelperClass();
            ...
            if (headers != null) {
                ...
                for (; xe.hasMoreElements(); ) {
                    ...
                    MyHelperClass RFC2822Headers = new MyHelperClass();
...
public MyHelperClass storeDraftMessage(MyHelperClass o0, MimeMessage o1, Users o2){ return null; }
