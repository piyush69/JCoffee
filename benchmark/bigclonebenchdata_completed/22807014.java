...
//    @Test
    public void test() throws Throwable, JDOMException, IOException {
        ...
        for (float time = 0; time < 60; time += 0.1f) {
            ...
            for (RoadObject roadObject : se.getDynamicObjects()) {
                Vehicle vehicle = (Vehicle)(Vehicle)(Object) roadObject;
...
public MyHelperClass getSpeed(){ return null; }
	...
	public MyHelperClass getVehicleId(){ return null; }}
