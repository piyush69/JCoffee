...
public MyHelperClass cookies;
	public MyHelperClass boundary;
	public MyHelperClass response;
	public MyHelperClass postFile(PrintStream o0, HttpURLConnection o1, String o2, String o3, byte[] o4){ return null; }
	public MyHelperClass getCookies(List<String o0){ return null; }
    ...
    String sendRequest(String[] getVars, String[] postVars, Object[] fileVars, boolean getSessionKey) throws IOException {
        MyHelperClass wikiBaseURI = new MyHelperClass();
