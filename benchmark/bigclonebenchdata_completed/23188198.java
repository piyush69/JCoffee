...
class c23188198 {
public MyHelperClass addOutput(String o0, ProcessorOutput o1){ return null; }

    public ProcessorOutput createOutput(String name)  throws Throwable {
        ProcessorOutput output = new CacheableTransformerOutputImpl(getClass(), name) {

            protected void readImpl(PipelineContext context, final ContentHandler contentHandler) {
                MyHelperClass INPUT_DATA = new MyHelperClass();
                ProcessorInput i = getInputByName(INPUT_DATA);
                try {
                    MyHelperClass INPUT_CONFIG = new MyHelperClass();
...
class CacheableTransformerOutputImpl {

CacheableTransformerOutputImpl(Class<CAP#1> o0, String o1){}
	CacheableTransformerOutputImpl(){}}
