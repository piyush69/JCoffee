...
public MyHelperClass getStoreInstance(HttpServletRequest o0){ return null; }
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Throwable, Exception {
        ...
        try {
            ...
            Store storeInstance =(Store)(Object) getStoreInstance(request);
            if (isMultipart) {
...
public MyHelperClass send(Vector o0, int o1, MyHelperClass o2){ return null; }}
