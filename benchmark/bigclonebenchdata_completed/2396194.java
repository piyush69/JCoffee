...
class c2396194 {
public static MyHelperClass extractOutsideTextFast(String o0, char o1, char o2, Vector o3, boolean o4, StringBuffer o5){ return null; }
//public MyHelperClass extractOutsideTextFast(String o0, char o1, char o2, Vector o3, boolean o4, StringBuffer o5){ return null; }
	public static MyHelperClass extractWordsFromSpacedList(String o0){ return null; }
    ...
    public static Vector getKeywordsFromURLFast(String p_url) throws Exception {
        ...
        if (x_bod == false) {
            if (x_title_line != null) {
                x_words = new Vector();
                x_temp_words =(String[])(Object) extractWordsFromSpacedList(x_title_line);
        ...
        do {
            ...
            x_status =(boolean)(Object) extractOutsideTextFast(x_line, '<', '>', x_words, x_status, x_buf);
        } while ((x_line =(String)(Object) x_reader.readLine()) != null);
