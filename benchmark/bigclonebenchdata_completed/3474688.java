...
class c3474688 {
public MyHelperClass connectSettings;
	public MyHelperClass lastResult;

    public void connect(final URLConnectAdapter urlAdapter)  throws Throwable {
        ...
        try {
            ...
            this.lastResult =(MyHelperClass)(Object) result;
        } catch (IOException e) {
            throw new ConnectException((String)(Object)e);
        }
    }
...
class URLConnectAdapter {

public MyHelperClass openConnection(){ return null; }}

class ConnectResult {

ConnectResult(int o0, String o1){}
	ConnectResult(){}
	public MyHelperClass addHeader(String o0, String o1, List<String o2){ return null; }}
