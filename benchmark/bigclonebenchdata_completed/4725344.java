...
public MyHelperClass Utils;
	public MyHelperClass includeOrExcludeClass(String o0, String o1, List<String,List<String,List<String o2){ return null; }
	public MyHelperClass matchTestClasspath(URL o0, String o1, boolean o2){ return null; }
	public MyHelperClass findClassesInDirPackage(String o0, List<String,List<String o1, String o2, boolean o3, List<String o4){ return null; }

    public static String[] findClassesInPackage(String packageName, List<String> included, List<String> excluded) throws Throwable, IOException {
