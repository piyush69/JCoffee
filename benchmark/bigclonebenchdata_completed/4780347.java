...
class c4780347 {
public MyHelperClass postheaderlines;
	public MyHelperClass preheaderlines;
	public MyHelperClass singleFormatText;
	public MyHelperClass hasHeaderLineBox;
	public MyHelperClass setSize(Dimension o0){ return null; }
	public MyHelperClass updateDetailsFor(String o0){ return null; }
	public MyHelperClass setLayout(GridLayout o0){ return null; }
public MyHelperClass flatfilesource;
	public MyHelperClass Box;
	public MyHelperClass rows2show;
	public MyHelperClass isURLButton;
	public MyHelperClass leastrow;
	public MyHelperClass executeTransfer(){ return null; }
	public MyHelperClass getNickname(){ return null; }
	public MyHelperClass setNickname(String o0){ return null; }
public MyHelperClass leastcolumn;
	public MyHelperClass connectionHandler;
	public MyHelperClass createdByText;
	public MyHelperClass commentTextArea;
	public MyHelperClass enabledRadio;
	public MyHelperClass NoCallbackChangeMode;
	public MyHelperClass iconServer;
	public MyHelperClass repositoryView;
	public MyHelperClass fmtlistener;
	public MyHelperClass chooser;
	public MyHelperClass repositoryEditor;
	public MyHelperClass preview;
	public MyHelperClass Config;
	public MyHelperClass prefsEditor;
	public MyHelperClass createdOnText;
	public MyHelperClass Prefs;
	public MyHelperClass addSources;
	public MyHelperClass nicknameText;
	public MyHelperClass Connection;
	public MyHelperClass reposListeners;
	public MyHelperClass removeFormatButton;
	public MyHelperClass map;
	public MyHelperClass transferAgent;
	public MyHelperClass previewPanel;
	public MyHelperClass editPrefsButton;
	public MyHelperClass uploadButton;
	public MyHelperClass columns2show;
	public MyHelperClass getStorageTransferAgentClass(){ return null; }

    public  c4780347()  throws Throwable {
        super("Specify Your Flat File Data");
        try {
            Class transferAgentClass =(Class)(Object)(Object)(Object) this.getStorageTransferAgentClass();
            ...
            Constructor constr =(Constructor)(Object)(Object)(Object) transferAgentClass.getConstructor(parameterTypes);
            Object[] actualValues = new Object[] {(Object)(Object) this };
            this.transferAgent = (RepositoryStorageTransferAgent)(RepositoryStorageTransferAgent)(Object) constr.newInstance(actualValues);
        } catch (Exception err) {
            throw new RuntimeException("Unable to instantiate transfer agent.", err);
        }
        this.fmtlistener =(MyHelperClass)(Object) new FormatTableModelListener();
        this.map =(MyHelperClass)(Object)(Object)(Object) new HashMap();
        this.NoCallbackChangeMode =(MyHelperClass)(Object)(Object)(Object) false;
        this.setSize(new Dimension(1000, 400));
        this.setLayout(new GridLayout(1, 1));
        this.Config =(MyHelperClass)(Object) new FlatFileToolsConfig();
        this.Config.initialize();
        this.connectionHandler = new RepositoryConnectionHandler(this.Config);
        this.Connection = (FlatFileStorageConnectivity)(FlatFileStorageConnectivity)(Object) this.connectionHandler.getConnection("default");
        this.Prefs =(MyHelperClass)(Object) new FlatFileToolsPrefs();
        this.Prefs.initialize();
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        String formatted_date =(String)(Object) formatter.format(new Date());
        this.createdOnText = new JTextField(formatted_date);
        this.createdByText = new JTextField(this.Prefs.getConfigValue("createdby"));
        this.reposListeners =(MyHelperClass)(Object)(Object)(Object) new Vector();
        ...
        this.chooser =(MyHelperClass)(Object) new JFileChooser();
        ...
        this.iconServer =(MyHelperClass)(Object) new IconServer();
        ...
        this.uploadButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                ...
                try {
                    String expname =(String)(Object) getNickname();
                    int split = expname.lastIndexOf('.');
                    String domain = "";
                    String name = "";
                    String usersdomain =(String)(Object) Prefs.getConfigValue("default", "domainname");
                    if (split > 0) {
...
//                        MyHelperClass JOptionPane = new MyHelperClass();
        ...
        this.prefsEditor.addCloseListener((CloseListener)(Object)new ActionListener() {

            public void actionPerformed(ActionEvent ev) {
                prefsEditor.setVisible(false);
            }
        });
        this.prefsEditor.addSelectListener((SelectListener)(Object)new ActionListener() {
        ...
        this.leastcolumn =(MyHelperClass)(Object) new JSpinner();
        this.columns2show =(MyHelperClass)(Object) new JSpinner();
        this.leastrow =(MyHelperClass)(Object) new JSpinner();
        this.rows2show =(MyHelperClass)(Object) new JSpinner();
        int rowCount = 10;
        JLabel sourceLabel = new JLabel("File Source");
        this.flatfilesource =(MyHelperClass)(Object) new JTextField();
        ...
        this.hasHeaderLineBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                MyHelperClass fileselector = new MyHelperClass();
                int selectedRow = fileselector.getSelectedRow();
                if (selectedRow >= 0) {
                    MyHelperClass sourcemodel = new MyHelperClass();
                    String fn = (String) sourcemodel.getValueAt(selectedRow, 0);
                    if (fn != null) {
                        fn = fn.trim();
...
public MyHelperClass setEditable(boolean o0){ return null; }
	public MyHelperClass addSelectListener(){ return null; }
	public MyHelperClass getText(){ return null; }
	public MyHelperClass showMessageDialog(Object o0, String o1){ return null; }
	public MyHelperClass addCloseListener(){ return null; }
	public MyHelperClass setConfigFile(MyHelperClass o0){ return null; }
	public MyHelperClass initialize(){ return null; }
	public MyHelperClass setText(String o0){ return null; }
	public MyHelperClass getConfigValue(String o0){ return null; }
	public MyHelperClass addCloseListener(CloseListener o0){ return null; }
	...
	public MyHelperClass setCurrentRepository(MyHelperClass o0){ return null; }
	public MyHelperClass createHorizontalBox(){ return null; }
	public MyHelperClass setToolTipText(String o0){ return null; }
	public MyHelperClass getConfigValue(String o0, String o1){ return null; }
	...
	public MyHelperClass setNameTextToolTipText(String o0){ return null; }
	public MyHelperClass getConnection(String o0){ return null; }
	public MyHelperClass setMaximumSize(Dimension o0){ return null; }
	public MyHelperClass addSelectListener(SelectListener o0){ return null; }
...
class RepositoryStorageTransferAgent {

}

class FormatTableModelListener {

}

class FlatFileToolsConfig {

}

class RepositoryConnectionHandler {

RepositoryConnectionHandler(MyHelperClass o0){}
	RepositoryConnectionHandler(){}}

class FlatFileStorageConnectivity {

}

class FlatFileToolsPrefs {

}

class JTextField {

JTextField(MyHelperClass o0){}
	JTextField(String o0){}
	JTextField(){}}
...
class IconifiedDomainNameTextField {

}

class FlatFileFindNameDialog {

FlatFileFindNameDialog(MyHelperClass o0, MyHelperClass o1){}
	FlatFileFindNameDialog(){}}

class PrefsConfigFrame {

PrefsConfigFrame(MyHelperClass o0){}
	PrefsConfigFrame(){}}

class ReposConfigFrame {

ReposConfigFrame(MyHelperClass o0){}
	ReposConfigFrame(){}}
...
public MyHelperClass add(JLabel o0){ return null; }
	public MyHelperClass add(Box o0){ return null; }
