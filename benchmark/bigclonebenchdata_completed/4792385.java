...
public MyHelperClass LOG;
	...
	public MyHelperClass updateFilesTable(){ return null; }
    ...
    private void upgradeSchema() {
        ...
        try {
            ...
            while (i < (int)(Object)SCHEMA_VERSION) {
                ...
                switch(i) {
                    ...
                    case 11:
                        ...
                        try {
                            MessageDigest msg =(MessageDigest)(Object) MessageDigest.getInstance("MD5");
                            msg.update("sjqadmin".getBytes());
                            String pwd = new String((String)(Object)msg.digest());
                            pstmt =(PreparedStatement)(Object) conn.prepareStatement("REPLACE INTO settings (var, val) VALUES ('password', ?)");
                            pstmt.setString(1, pwd);
                            pstmt.executeUpdate();
                        } catch (UncheckedIOException e) {
                            throw new SQLException((String)(Object)e);
                        } finally {
            ...
            try {
                ...
                LOG.fatal("SQL error",(SQLException)(Object) x);
            }
            ...
            try {
                ...
                LOG.fatal("SQL error",(SQLException)(Object) e);
                throw new RuntimeException(e);
            }
        }
    }
