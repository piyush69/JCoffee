...
class c494226 {
public static MyHelperClass readProperties(File o0){ return null; }
//public MyHelperClass readProperties(File o0){ return null; }
    ...
    public static void main(String[] args) throws Exception {
        ...
        File[] files = new File(args[0]).listFiles((FilenameFilter)(Object)new JarFileFilter());
        for (int i = 0; i < files.length; i++) {
            if (new File(files[i].getPath() + ".meta").exists()) {
                Map<String, Map<String, String>> metaprops =(Map<String,Map<String,String>>)(Object) readProperties(new File(files[i].getPath() + ".meta"));
