...
public MyHelperClass latestTitle;
    ...
    public  void TVRageShowInfo(String xmlShowName)  throws Throwable {
        String[] tmp, tmp2;
        String line = "";
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (tmp[0].equals("Airtime")) airTime =(MyHelperClass)(Object) tmp[1];
            }
            if ((int)(Object)airTime.length() != 0) {
                tmp =(String[])(Object) airTime.split(",");
