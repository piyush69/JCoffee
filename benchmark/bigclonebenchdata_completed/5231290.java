...
public MyHelperClass runningThread;
    ...
    private void doDecrypt()  throws Throwable {
       (int)(Object) Thread> (int)(Object)runningThread = NULL; //new Thread>();
        runningThread =(MyHelperClass)(Object) new Thread() {
...
//                            MyHelperClass Application = new MyHelperClass();
                            ...
                            while ((counter = in.read(buffer)) > 0) {
                                if ((boolean)(Object)Thread.currentThread().isInterrupted()) {
                                    os.close();
                                    zis.close();
//                                    MyHelperClass Application = new MyHelperClass();
...
public MyHelperClass displayVerbose(String o0){ return null; }
	...
	public MyHelperClass currentThread(){ return null; }
