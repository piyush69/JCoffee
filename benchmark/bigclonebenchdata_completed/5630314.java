...
public MyHelperClass AeCloser;
    ...
    public Document getWsdlDomResource(String aResourceName) throws Throwable, AeException {
...
class AeException extends Exception{
	public AeException(String errorMessage) { super(errorMessage); }
}
