...
class c6008880 {
public MyHelperClass genereateServlet(String o0, String o1){ return null; }
    ...
    protected void updateJava2ScriptProject(String prjFolder, String binRelative) {
        try {
            ...
            MyHelperClass J2SLaunchingUtil = new MyHelperClass();
            String classpath =(String)(Object) J2SLaunchingUtil.readAFile(fis);
            if (classpath != null) {
            ...
            lib.mkdir();
            IPath newPath = null;
            MyHelperClass AjaxPlugin = new MyHelperClass();
            URL starterURL =(URL)(Object) AjaxPlugin.getDefault().getBundle().getEntry(File.separator);
            String root = ".";
            try {
                MyHelperClass Platform = new MyHelperClass();
                root =(String)(Object) Platform.asLocalURL(starterURL).getFile();
            } catch (UncheckedIOException e1) {
                e1.printStackTrace();
            }
            MyHelperClass Path = new MyHelperClass();
            newPath =(IPath)(Object) Path.fromPortableString(root + "/ajaxrpc.jar");
            File rpcFile = new File((String)(Object)newPath.toOSString());
            try {
...
//            MyHelperClass Path = new MyHelperClass();
            newPath =(IPath)(Object) Path.fromPortableString(root + "/ajaxpipe.jar");
            File pipeFile = new File((String)(Object)newPath.toOSString());
            try {
            ...
            buildxml.append("\r\n");
//            MyHelperClass AjaxPlugin = new MyHelperClass();
            starterURL =(URL)(Object) AjaxPlugin.getDefault().getBundle().getEntry(File.separator);
            root = ".";
            try {
                MyHelperClass Platform = new MyHelperClass();
                root =(String)(Object) Platform.asLocalURL(starterURL).getFile();
...
//            MyHelperClass Path = new MyHelperClass();
            newPath =(IPath)(Object) Path.fromPortableString(root);
            String ajaxPath =(String)(Object) newPath.toOSString();
            ...
            String j2sRelativePath =(String)(Object) FileUtil.toRelativePath(libFile.getAbsolutePath(), webinf.getAbsolutePath());
...
public MyHelperClass asLocalURL(URL o0){ return null; }
	public MyHelperClass getDefault(){ return null; }
	public MyHelperClass readAFile(FileInputStream o0){ return null; }
	public MyHelperClass getEntry(String o0){ return null; }
	public MyHelperClass fromPortableString(String o0){ return null; }
	public MyHelperClass toRelativePath(String o0, String o1){ return null; }
