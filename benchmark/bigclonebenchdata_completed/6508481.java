...
class c6508481 {
    ...
    static void invalidSlave(String msg, Socket sock) throws IOException {
        ...
        try {
            ...
            logger.info("NEW< " + msg);
            MyHelperClass AsyncSlaveListener = new MyHelperClass();
            String txt =(String)(Object) AsyncSlaveListener.readLine(_sinp, 30);
            String sname = "";
            String spass = "";
            String shash = "";
            try {
...
//            MyHelperClass AsyncSlaveListener = new MyHelperClass();
            String hash =(String)(Object) AsyncSlaveListener.hash2hex(md5.digest()).toLowerCase();
