...
class c7901579 {
    ...
    public static long writePropertiesInOpenXMLDocument(String ext, InputStream in, OutputStreamProvider outProvider, Map<String, String> properties)  throws Throwable {
...
//                MyHelperClass Metadata = new MyHelperClass();
                    ...
                    if ((boolean)(Object)customProperties.contains(property.getKey())) {
                        int index = 0;
...
public MyHelperClass addProperty(String o0, String o1){ return null; }
	public MyHelperClass getUnderlyingProperties(){ return null; }
