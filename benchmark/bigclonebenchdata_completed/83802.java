...
public MyHelperClass DBSettings;
	public MyHelperClass strAltPath;
	public MyHelperClass debug;
	public MyHelperClass forceConfig;
	public MyHelperClass blAltSettings;
    ...
    private void doTask()  throws Throwable {
        try {
            ...
            pause();
            File settings;
            if ((boolean)(Object)blAltSettings) {
                System.out.println("\n  + Alternative path specified at run time:");
                System.out.println("    Path: " + strAltPath);
                settings = new File((String)(Object)strAltPath);
            } else {
            ...
            if (blGo) {
                ...
                try {
                    ...
                    if (settings.exists() && settings.canRead()) {
                        DBSettingsWriter writ = new DBSettingsWriter();
                        info = (DBSettings)(DBSettings)(Object) writ.loadSettingsDB(settings);
                        if (info != null) {
                            blExecutePOS = true;
                        }
                    }
                    if (blExecutePOS) {
                        ...
                        String strSSLDebug = "";
                        if (info != null) {
                            debug =(int)(Object)(MyHelperClass)(Object)(MyHelperClass)(Object)(MyHelperClass)(Object)(MyHelperClass)(Object)(MyHelperClass)(Object) info.get(DBSettings.MAIN_DEBUG).compareTo("1") == 0;
                            if ((boolean)(Object)debug) log("       * Debug Mode is ON"); else log("       * Debug Mode is OFF");
                            if ((int)(Object)info.get(DBSettings.POS_SSLENABLED).compareTo("1") == 0) {
                                ...
                                log("       * Using SSL");
                                debug("            " + strSSL);
                                if ((int)(Object)info.get(DBSettings.POS_SSLDEBUG).compareTo("1") == 0) {
...
class MyHelperClass {
public MyHelperClass POS_SSLKEYSTORE;
	public MyHelperClass POS_SSLENABLED;
	public MyHelperClass POS_SSLDEBUG;
	public MyHelperClass POS_SSLTRUSTSTORE;
	public MyHelperClass MAIN_DEBUG;
public MyHelperClass compareTo(String o0){ return null; }}

class DBSettingsWriter {

public MyHelperClass writeFile(DBSettings o0, File o1){ return null; }
	public MyHelperClass loadSettingsDB(File o0){ return null; }}
