...
public MyHelperClass checkConnectionStateParameters(HttpsURLConnection o0, SSLSocket o1){ return null; }
	public MyHelperClass doPersistentInteraction(HttpsURLConnection o0, ServerSocket o1){ return null; }
public MyHelperClass HttpsURLConnection;
    ...
    public void testHttpsPersistentConnection() throws Throwable {
        ...
        try {
            ...
            SSLSocket peerSocket = (SSLSocket)(SSLSocket)(Object) doPersistentInteraction(connection, ss);
