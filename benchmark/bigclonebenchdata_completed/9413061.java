    ...
    public void run() {
        try {
            ...
            for (int i = 1; i <= (int)(Object)noofparts; i++) {
                ...
                FileChannel in = (FileChannel)(Object)new FileInputStream(originalfilename.getAbsolutePath() + "." + String.format("%03d", i)).getChannel();
//                MyHelperClass status = new MyHelperClass();
                ...
                in.close();
                if ((boolean)(Object)deleteOnFinish) new File(originalfilename + String.format(".%03d", i)).delete();
