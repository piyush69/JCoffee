...
public MyHelperClass _cman;
	...
	public MyHelperClass SocketSlaveListener;
    ...
    public void init(ConnectionManager mgr, Hashtable cfg, Socket sock) throws RemoteException {
        ...
        try {
            ...
            try {
                ...
                SocketSlaveListener.invalidSlave("INITFAIL BadKey",(MyHelperClass)(Object) _sock);
            }
            ...
            if (!sname.equals(_name)) {
                SocketSlaveListener.invalidSlave("INITFAIL Unknown",(MyHelperClass)(Object) _sock);
            }
...
public MyHelperClass getSlaveManager(){ return null; }
	...
	public MyHelperClass addSlave(MyHelperClass o0, c9613072 o1, MyHelperClass o2, int o3){ return null; }}
