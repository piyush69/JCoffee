...
class c9678341 {
    ...
    public static void copy(Object arg1, Object arg2)  throws Throwable {
        Writer writer = null;
        Reader reader = null;
        ...
        try {
            if (arg2 instanceof Writer) {
                ...
                if (arg1 instanceof Reader) {
                    ...
                    throw(Throwable)(Object) new TypeError("Invalid first argument to copy()");
                }
                ...
                throw(Throwable)(Object) new TypeError("Invalid second argument to copy()");
            }
        } catch (IOException e) {
            throw(Throwable)(Object) new IOError(e.getMessage(), e);
        }
    }
...
IOError(){}
	IOError(String o0, IOException o1){}}
