...
public MyHelperClass Logger;
	public MyHelperClass vc_disabled_plugins;
	public MyHelperClass PluginLauncherImpl;
	public MyHelperClass AEVerifier;
	public MyHelperClass MessageText;
	public MyHelperClass Debug;
	public MyHelperClass LogAlert;
	public MyHelperClass default_version_details;
	public MyHelperClass FileUtil;
	public MyHelperClass UpdaterUpdateChecker;
	public MyHelperClass LOGID;
	public MyHelperClass getPluginFromClass(String o0){ return null; }
	public MyHelperClass log(String o0){ return null; }
	public MyHelperClass checkAzureusVersion(String o0, Properties o1, boolean o2){ return null; }
	public MyHelperClass checkJDKVersion(String o0, Properties o1, boolean o2){ return null; }

    private List loadPluginFromDir(File directory, boolean bSkipAlreadyLoaded, boolean loading_for_startup, boolean initialise) throws Throwable, PluginException {
        List loaded_pis = new ArrayList();
        MyHelperClass root_class_loader = new MyHelperClass();
        ...
        MyHelperClass PluginLauncherImpl = new MyHelperClass();
        ...
        try {
            ...
            try {
                ...
                MyHelperClass LogAlert = new MyHelperClass();
